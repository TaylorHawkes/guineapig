...
g++ main.cpp ../MPU6050/I2Cdev.o ../MPU6050/MPU6050.o common/shader.o common/controls.o common/texture.o v4l2_driver.o -lGL -lglut -lGLEW -lglfw  -lSDL2 -lSDL2_image -lm 
