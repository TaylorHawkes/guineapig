...
//#define ENABLE_NVRAM_STORAGE//taylor removed this
...
#define IMU_COMPASS_SAMPLE_RATE 100 // Compass sample rate (4-100 Hz)//100 cycles per second
...
// SD Logging Config //
///////////////////////
#define ENABLE_SD_LOGGING false // Taylor Chaing this to false Default SD logging (can be changed via serial menu)
