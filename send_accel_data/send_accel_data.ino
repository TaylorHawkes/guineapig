...
bool enableCalculatedValues = true;
...
//   }
  ...
  */
  ...
  imuLog += "\r\n"; // Add a new line
  int str_len = imuLog.length() + 1; 
  //convert string to char array
  char __imuLog[str_len];
  imuLog.toCharArray(__imuLog, str_len);
  //imuLog.toCharArray(__imuLog, 16);
// LOG_PORT.println(sizeof(imuLog));
